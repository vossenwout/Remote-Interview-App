...
function Re(t2, e) {
  for (var n = null, r = 0, i = t2.fieldTransforms; r < i.length; r++) {
    ...
    u != null && (n == null && (n = Et.empty()), n.set(o.field, u));
  }
  return n || null;
}
function Le(t2, e) {
...
function Fn(t2, e) {
  var n = e.currentDocument ? function(t3) {
    return t3.updateTime !== void 0 ? De.updateTime(En(t3.updateTime)) : t3.exists !== void 0 ? De.exists(t3.exists) : De.none();
...
var Es = function() {
  ...
  return t2.prototype.oo = function(t3) {
    ...
    for (var e = new Map(), n = new _s(this.R), r = 0, i = t3; r < i.length; r++) {
      var o = i[r];
...
var lc2 = function() {
  ...
  return t2.prototype.set = function(t3, e, n) {
    ...
    var r = dc2(t3, this._firestore), i = hc2(r.converter, e, n), o = _a(this._dataReader, "WriteBatch.set", r._key, i, r.converter !== null, n);
...
function yc2(t2, e, n) {
  ...
  return gc2(r, [_a(Ta(r), "setDoc", t2._key, i, t2.converter !== null, n).toMutation(t2._key, De.none())]);
}
function vc2(t2, e, n) {
  for (var r = [], i = 3; i < arguments.length; i++)
    r[i - 3] = arguments[i];
  ...
  return gc2(o, [(typeof (e = getModularInstance(e)) == "string" || e instanceof la2 ? xa2(s, "updateDoc", t2._key, e, n, r) : Ca2(s, "updateDoc", t2._key, e)).toMutation(t2._key, De.exists(true))]);
}
function mc2(t2) {
...
var bc2 = function(e) {
  ...
  return t2.prototype.get = function(t3) {
    ...
    var r = dc2(t3, this._firestore), i = hc2(r.converter, e, n), o = _a(this._dataReader, "Transaction.set", r._key, i, r.converter !== null, n);
...
var Cc2 = function() {
  ...
  return t2.prototype.fromFirestore = function(t3, e) {
    ...
    return this._delegate.fromFirestore(new Fc2(this._firestore, n), e != null ? e : {});
...
var xc2 = function() {
  ...
  return t2.iu = function(e, n, r) {
    ...
    for (var r = [], i = 2; i < arguments.length; i++)
      r[i - 2] = arguments[i];
    try {
      return arguments.length === 1 ? vc2(this._delegate, t3) : vc2.apply(void 0, __spreadArray([this._delegate, t3, n], r));
    } catch (t4) {
    ...
    return ((t3 == null ? void 0 : t3.source) === "cache" ? function(t4) {
      ...
      return function(t5, e3) {
        ...
        return new za2(e2, o, t4._key, n, new Qa(n !== null && n.hasLocalMutations, true), t4.converter);
      });
...
var Uc2 = function(e) {
  ...
  return __extends(n, e), Object.defineProperty(n.prototype, "id", {
    ...
    try {
      return new xc2(this.firestore, t2 === void 0 ? ta2(this._delegate) : ta2(this._delegate, t2));
    } catch (t3) {
    ...
    return function(t3, e3) {
      ...
      return gc2(n2, [_a(Ta(t3.firestore), "addDoc", r._key, i, t3.converter !== null, {}).toMutation(r._key, De.exists(false))]).then(function() {
        return r;
      });
